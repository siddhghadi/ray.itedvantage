...
?>
<!doctype html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><meta name="robots" content="noindex,nofollow"><title>Construction · RAY</title><link rel="stylesheet" href="assets/app.css?v=105"><link rel="stylesheet" href="assets/phase1.css?v=105"><link rel="stylesheet" href="assets/phase23.css?v=105"><link rel="stylesheet" href="assets/phase4.css?v=105"><link rel="stylesheet" href="assets/phase4nav.css?v=105"><link rel="stylesheet" href="assets/phase56.css?v=105"><link rel="stylesheet" href="assets/roles.css?v=105"><link rel="stylesheet" href="assets/users.css?v=105"><link rel="stylesheet" href="assets/role-catalogue.css?v=105"><link rel="stylesheet" href="assets/projects.css?v=105"><script defer src="assets/app.js?v=105"></script></head><body>
<link rel="stylesheet" href="assets/projects.css?v=108"><link rel="stylesheet" href="assets/inventory.css?v=109"><aside class="side"><div class="brand"><span class="mark"><?=e(strtoupper(substr($companyName,0,1)))?></span><div><b>Construction</b><small><?=e($companyName)?></small></div></div><nav class="nav"><a href="../">← All businesses</a><small>MATERIAL CONTROL</small><a class="<?=$page==='dashboard'?'active':''?>" href="./">Dashboard</a><a class="<?=$page==='projects'?'active':''?>" href="?page=projects">Construction Sites</a><a class="<?=$page==='inventory'?'active':''?>" href="?page=inventory">All Inventory</a><a class="<?=$page==='transfers'?'active':''?>" href="?page=transfers">Excess & Transfers</a><a class="<?=$page==='materials'?'active':''?>" href="?page=materials">Site Materials</a><a class="<?=$page==='reports'?'active':''?>" href="?page=reports">Monthly Reports</a><small>PROCUREMENT</small><a class="<?=$page==='purchases'?'active':''?>" href="?page=purchases">Purchases</a><a class="<?=$page==='vendors'?'active':''?>" href="?page=vendors">Vendors</a><small>ADMINISTRATION</small><a class="<?=$page==='users'?'active':''?>" href="?page=users">Team</a><a class="<?=$page==='roles'?'active':''?>" href="?page=roles">Roles & Permissions</a><a class="<?=$page==='company'?'active':''?>" href="?page=company">Company Settings</a></nav><div class="profile"><b><?=e($user['name'])?></b><small><?=e($user['email'])?></small></div></aside>
<main class="app"><header class="top"><button class="menu" data-menu>Menu</button><b><?=e($companyName)?> Inventory</b><div class="top-context">Construction Material Control</div><form class="period-switcher" method="get"><input type="hidden" name="page" value="<?=e($page)?>"><?php if(isset($_GET['project'])):?><input type="hidden" name="project" value="<?=e((string)$_GET['project'])?>"><?php endif;?><label>View<select name="period" onchange="this.form.submit()"><option value="daily" <?=$inventoryPeriod==='daily'?'selected':''?>>Daily</option><option value="monthly" <?=$inventoryPeriod==='monthly'?'selected':''?>>Monthly</option><option value="yearly" <?=$inventoryPeriod==='yearly'?'selected':''?>>Yearly</option></select></label></form><button class="push" data-fullscreen>Fullscreen</button><form method="post"><input type="hidden" name="csrf" value="<?=e($_SESSION['csrf'])?>"><button name="logout" value="1">Sign out</button></form></header><div class="content"><?php if($notice):?><p class="success-note"><?=e($notice)?></p><?php endif;?><?php if($error):?><p class="error"><?=e($error)?></p><?php endif;?><?php if($migrationError):?><p class="error">Setup check: <?=e($migrationError)?></p><?php endif;?>
